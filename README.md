Tarifario de Piezas de Marketing - Shopping Managements S.A.
...
Este aplicativo permite a los usuarios del departamento de marketing de Shopping Managements S.A. gestionar un catálogo dinámico de piezas. Facilita la toma de decisiones al mostrar automáticamente el mejor precio disponible entre múltiples proveedores y permitir la edición rápida de especificaciones técnicas como medidas y materiales.
...
Bash
git clone https://github.com/FernandoQuiguantar/Proyecto_Integrador_Tarifario.git
...
src/components/: Componentes UI reutilizables (Button, TextInput).

src/data/material.js: Fuente de datos estructurada para el tarifario.

src/App.jsx: Orquestador principal de la aplicación y lógica de negocio.

Desarrollado por: Fernando Quiguantar

Institución: PUCE - Proyecto Integrador
